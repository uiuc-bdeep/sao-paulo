...
iv.1 <- felm(tr.time ~ fitted.blocks + fitted.floods + fitted.spill +
...
iv.2 <- felm(tr.time ~ fitted.blocks + fitted.floods + fitted.spill +
...
iv.3 <- felm(tr.time ~ fitted.blocks + fitted.floods + fitted.spill +
...
iv.4 <- felm(tr.time ~ fitted.blocks + fitted.floods + fitted.spill +
