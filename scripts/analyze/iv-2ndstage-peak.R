...
iv.1 <- felm(tr.time ~ fitted.blocks:early.peak + fitted.floods:early.peak + 
                       ...
                       fitted.blocks:off.peak + fitted.floods:off.peak | ID_ORDEM | 0 | ID_ORDEM, data = trips)
...
iv.2 <- felm(tr.time ~ fitted.blocks:early.peak + fitted.floods:early.peak + 
                       fitted.blocks:late.peak + fitted.floods:late.peak + 
                       fitted.blocks:off.peak + fitted.floods:off.peak | ID_ORDEM + month | 0 | ID_ORDEM, data = trips)
...
iv.3 <- felm(tr.time ~ fitted.blocks:early.peak + fitted.floods:early.peak + 
                       fitted.blocks:late.peak + fitted.floods:late.peak + 
                       fitted.blocks:off.peak + fitted.floods:off.peak  | ID_ORDEM + month + wd | 0 | ID_ORDEM, data = trips)
...
iv.4 <- felm(tr.time ~ fitted.blocks:early.peak + fitted.floods:early.peak +
                       fitted.blocks:late.peak + fitted.floods:late.peak +
                       fitted.blocks:off.peak + fitted.floods:off.peak  | ID_ORDEM + month + wd + hour.f | 0 | ID_ORDEM, data = trips)
